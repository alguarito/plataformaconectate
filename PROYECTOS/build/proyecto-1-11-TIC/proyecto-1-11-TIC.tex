...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-1-11-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 11 · Periodo Primero}\\[1.0cm]
...
DBA del periodo & Desarrolla sitios web profesionales y gestiona su presencia digital en la infoesfera\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: sitio o micrositio informativo sobre una problemática social.\\
\end{tabularx}
...
\item Fundamentos del desarrollo web: estructura del documento HTML5 — etiquetas semánticas
\item HTML5 I: texto, listas, enlaces e imágenes — estructura y jerarquía de contenidos
\item HTML5 II: tablas, formularios y elementos multimedia — accesibilidad web básica
\item CSS3 I: selectores, propiedades y modelo de caja — estilos y maquetación
\item CSS3 II: diseño responsivo, Flexbox y media queries — usabilidad móvil
\item Tema central del periodo: HTML5, CSS3, CMS y Marketing Digital — Arquitectura de Sentido
\item Marketing digital I: SEO básico — optimización para motores de búsqueda
\item Tema central del periodo: HTML5, CSS3, CMS y Marketing Digital — Arquitectura de Sentido
\item Tema central del periodo: HTML5, CSS3, CMS y Marketing Digital — Arquitectura de Sentido
\item Tema central del periodo: HTML5, CSS3, CMS y Marketing Digital — Arquitectura de Sentido
\end{itemize}
...
Conceptos clave & Tema Central: HTML5, CSS3, CMS y Marketing Digital — Arquitectura de Sentido\\

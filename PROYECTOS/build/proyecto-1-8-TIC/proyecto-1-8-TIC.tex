...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-1-8-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 8 · Periodo Primero}\\[1.0cm]
...
DBA del periodo & Organiza y procesa datos numéricos para resolver problemas cotidianos mediante hojas de cálculo\\
Estrategia activa & Aprendizaje basado en datos + experimento escolar\\
Foco de diseño & recolectar datos, organizarlos, analizarlos y tomar decisiones con evidencia\\
Producto final & Informe con tablas, gráficos y recomendación basada en datos. Puede dialogar con el producto antiguo sugerido: informe de análisis de datos con tablas y gráficos.\\
\end{tabularx}
...
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\item Tipos de datos y formato de celdas — ingreso y organización de información numérica
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\item Funciones estadísticas: SUMA, PROMEDIO, MAX, MIN — aplicaciones en datos reales del entorno
\item Referencias relativas y absolutas — anclaje de celdas para cálculos complejos
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\item Formato condicional y validación de datos — presentación profesional de información
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\item Tema central del periodo: Excel Básico y Fórmulas — Análisis de Datos con Phronesis
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Excel Básico y Fórmulas — Análisis de Datos con Phronesis\\

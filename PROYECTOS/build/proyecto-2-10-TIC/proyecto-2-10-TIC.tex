...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-2-10-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 10 · Periodo Segundo}\\[1.0cm]
...
DBA del periodo & Comprende la arquitectura avanzada de hardware y ejecuta mantenimiento preventivo autónomo\\
...
\item Arquitectura de computadores I: estudio detallado de la placa base, chipset y buses de datos
\item Arquitectura de computadores II: tipos de memoria (RAM, ROM, caché) y jerarquía de almacenamiento
\item Configuración de BIOS/UEFI: parámetros de arranque, secuencia de booteo y diagnóstico
\item Mantenimiento preventivo I: protocolos de limpieza de hardware — herramientas y procedimientos
\item Mantenimiento preventivo II: optimización de software — desfragmentación, limpieza, gestión de inicio
\item Diagnóstico de fallas comunes: metodología sistemática de identificación y resolución de problemas
\item Instalación de software I: gestión de licencias, tipos de instalación y dependencias
\item Instalación de software II: sistemas operativos en máquinas virtuales (VirtualBox) y configuración de drivers
\item Proyecto MILC: guía técnica de mantenimiento para la sala de sistemas — autarquía técnica
\item Evaluación práctica de competencias en arquitectura y mantenimiento de sistemas
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Arquitectura de Computadores, BIOS/UEFI y Autarquía Técnica\\

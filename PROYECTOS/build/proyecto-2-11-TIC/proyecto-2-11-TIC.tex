...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Proyecto integrador · Grado 11}
...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-2-11-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 11 · Periodo Segundo}\\[1.0cm]
...
DBA del periodo & Aplica estándares de gestión de calidad ISO y normativa ético-legal en proyectos tecnológicos\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: diagnóstico de proceso con propuesta de mejora.\\
\end{tabularx}
...
\item Gestión de calidad I: introducción a ISO 9001 — principios del SGC y enfoque en procesos
\item Gestión de calidad II: ISO 21001 aplicada a organizaciones educativas — calidad como hábito virtuoso
\item Ciclo PDCA aplicado: Planear — definición de objetivos SMART y análisis de riesgos (phronesis)
\item Ciclo PDCA aplicado: Hacer — desarrollo siguiendo estándares técnicos y éticos (coraje/justicia)
\item Ciclo PDCA aplicado: Verificar — auditorías de pares y validación con usuario real (humildad)
\item Ciclo PDCA aplicado: Actuar — documentación de lecciones aprendidas y rediseño (templanza)
\item Marco legal: Ley 1581 de 2012 — protección de datos personales en proyectos tecnológicos
\item Sostenibilidad y economía circular: diseño de productos considerando ciclo de vida e impacto ambiental
\item Plan de negocios digital: viabilidad financiera — costos, ingresos y proyecciones de crecimiento
\item Evaluación de competencias en gestión de calidad y normatividad ético-legal
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: ISO 9001/21001, Ciclo PDCA, Ley 1581 y Economía Circular\\

...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Proyecto integrador · Grado 7}
...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-2-7-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 7 · Periodo Segundo}\\[1.0cm]
...
DBA del periodo & Desarrolla pensamiento algorítmico mediante programación visual por bloques aplicando el modelo PRIMM\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: algoritmo o diagrama de solución para un problema escolar o comunitario.\\
\end{tabularx}
...
\item Fundamentos de algoritmia: concepto de algoritmo como secuencia lógica de pasos
\item Variables, instrucciones y eventos — introducción al entorno de programación Scratch
\item Fase PRIMM — Predict/Run: análisis y ejecución de programas existentes en Scratch
\item Fase PRIMM — Investigate: desglose de estructuras lógicas en programas de ejemplo
\item Estructuras de control I: bucles (repeticiones) — iteración determinada e indeterminada
\item Estructuras de control II: condicionales simples — toma de decisiones en el código
\item Fase PRIMM — Modify: experimentación controlada modificando parámetros de programas
\item Depuración de errores con ataraxia estoica — documentación del proceso de debugging
\item Fase PRIMM — Make: creación de una narrativa digital interactiva (historia o juego básico)
\item Sustentación del proyecto de narrativa digital y evaluación de competencias computacionales
\end{itemize}
\end{multicols}
...
Conceptos clave & Diseña algoritmos como secuencias lógicas de instrucciones, variables y eventos en Scratch. Implementa estructuras de control: bucles (repeticiones) y condicionales simples. Crea historias interactivas o juegos básicos integrando personajes, fondos y sonidos.\\
...
Desempeño cognitivo & Define algoritmo, variable, evento, bucle y condicional con precisión conceptual. Explica la diferencia entre estructuras secuenciales, condicionales e iterativas. Describe las fases del modelo PRIMM: Predict, Run, Investigate, Modify, Make.\\
Desempeño procedimental & Programa en Scratch siguiendo el ciclo PRIMM: predice, ejecuta, investiga, modifica y crea. Depura errores lógicos en programas sencillos documentando el proceso de resolución. Desarrolla un proyecto de narrativa digital interactiva con al menos tres escenas programadas.\\
Desempeño actitudinal & Enfrenta los errores de programación con ataraxia estoica: cada bug es una oportunidad de aprendizaje. Demuestra paciencia y atención plena (prosochē) al analizar código antes de ejecutarlo. Valora la programación como techne (virtud como artesanía del pensamiento).\\
\end{tabularx}

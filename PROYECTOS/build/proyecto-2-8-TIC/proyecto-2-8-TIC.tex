...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-2-8-TIC}\\[8mm]
...
\item Lógica avanzada I: estructuras condicionales anidadas (if-else-if) — operadores lógicos AND/OR/NOT
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Sensores básicos: luz, temperatura — activación de eventos mediante código en MakeCode
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\item Proyecto MILC: sistema de monitoreo ambiental con sensores simulados — Logos como razón universal
\item Tema central del periodo: Lógica de Control y Computación Física — El Logos Universal
\end{itemize}
\end{multicols}

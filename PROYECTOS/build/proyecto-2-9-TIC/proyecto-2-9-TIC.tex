...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-2-9-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 9 · Periodo Segundo}\\[1.0cm]
...
DBA del periodo & Diseña publicaciones digitales y comprende los principios de redes e interconexión\\
Estrategia activa & Aprendizaje experiencial + laboratorio técnico\\
Foco de diseño & observar, diagnosticar, experimentar, registrar evidencias y proponer mejoras\\
Producto final & Diagnóstico técnico, protocolo de cuidado o mapa de sistema con evidencias. Puede dialogar con el producto antiguo sugerido: diagnóstico escolar de conectividad o comunicación.\\
\end{tabularx}
...
\item Diseño editorial digital I: fundamentos de autoedición — folletos y boletines informativos
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
\item Principios de redes I: concepto de emisor, receptor y canal — cómo funciona la radio y el Wi-Fi
\item Principios de redes II: Bluetooth, protocolos básicos de comunicación — arquitectura de red simple
\item Simulador de redes (Filius): construcción de arquitecturas de red virtuales — configuración de IP
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
\item Tema central del periodo: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia
...
Conceptos clave & Tema Central: Diseño Editorial, Redes y Simulación — La Infoesfera como Coexistencia\\

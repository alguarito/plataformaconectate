...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Proyecto integrador · Grado 10}
...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-1-10-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 10 · Periodo Primero}\\[1.0cm]
...
DBA del periodo & Gestiona la ética digital corporativa y utiliza herramientas de productividad profesional\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: guía técnica de mantenimiento preventivo.\\
\end{tabularx}
...
\item Ciberseguridad avanzada I: amenazas en la red — ransomware, suplantación de identidad, ingeniería social
\item Ciberseguridad avanzada II: análisis de casos éticos sobre el uso de datos masivos (Big Data)
\item Ataraxia digital: mantener el equilibrio mental ante incidentes de seguridad — resiliencia estoica
\item Productividad avanzada I: herramientas de gestión de proyectos — Trello/Asana/Notion
\item Productividad avanzada II: manejo corporativo del correo — respuestas automáticas, listas de distribución
\item Documentos colaborativos avanzados: gestión de flujos de trabajo en la nube para proyectos complejos
\item Firmas digitales y certificados electrónicos — autenticación y no repudio en entornos profesionales
\item Taller de gestión: planificación de un proyecto tecnológico con herramientas de productividad
\item Proyecto MILC: diagnóstico de ciberseguridad institucional con propuestas de mejora ética
\item Evaluación de competencias en ética digital y gestión corporativa
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Ciberseguridad Avanzada, Big Data y Gestión del Carácter Estoico\\

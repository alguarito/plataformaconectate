...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-3-10-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 10 · Periodo Tercero}\\[1.0cm]
...
DBA del periodo & Programa en Python para análisis de datos y diseña emprendimientos tecnológicos con valor humano\\
...
\item Tema central del periodo: Python, Pandas y Modelo CANVAS — Emprendimiento como Justicia
\item Algoritmia II: estructuras de control en pseudocódigo — secuencia, selección, iteración
\item Tema central del periodo: Python, Pandas y Modelo CANVAS — Emprendimiento como Justicia
\item Python I: estructuras condicionales y bucles — resolución de problemas matemáticos
\item Python II: funciones, listas y diccionarios — organización modular del código
\item Tema central del periodo: Python, Pandas y Modelo CANVAS — Emprendimiento como Justicia
\item Emprendimiento I: Modelo CANVAS — segmento de clientes, propuesta de valor, canales
\item Emprendimiento II: investigación de mercados con formularios digitales — validación de ideas locales
\item Proyecto MILC: prototipo de solución tecnológica con análisis de datos en Python — justicia social
\item Tema central del periodo: Python, Pandas y Modelo CANVAS — Emprendimiento como Justicia
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Python, Pandas y Modelo CANVAS — Emprendimiento como Justicia\\

...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-3-11-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 11 · Periodo Tercero}\\[1.0cm]
...
DBA del periodo & Integra todos los saberes en un proyecto final de innovación transmoderna con impacto social\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: propuesta formal de solución tecnológica comunitaria.\\
\end{tabularx}
...
\item Proyecto final I: definición del problema social/comunitario — Escuta analéctica con la comunidad
\item Proyecto final II: investigación y fundamentación teórica — sistematización de hallazgos
\item Proyecto final III: diseño de la solución tecnológica — integración de programación, datos y diseño
\item Proyecto final IV: desarrollo del prototipo funcional — aplicación del ciclo PDCA
\item Proyecto final V: documentación técnica completa — manual de usuario y documentación de código
\item Proyecto final VI: pruebas de usabilidad y validación con usuarios reales — enfoque al cliente
\item Proyecto final VII: iteración y mejora basada en retroalimentación — fortaleza estoica
\item Tema central del periodo: Proyecto Final de Innovación — Síntesis: Liberación, Infoesfera y Virtud
\item Tema central del periodo: Proyecto Final de Innovación — Síntesis: Liberación, Infoesfera y Virtud
\item Debates éticos contemporáneos: singularidad tecnológica, biotecnología y ciudadanía onlife global — cierre del ciclo formativo
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Proyecto Final de Innovación — Síntesis: Liberación, Infoesfera y Virtud\\

...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-3-7-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 7 · Periodo Tercero}\\[1.0cm]
...
DBA del periodo & Comprende los fundamentos de la IA y reflexiona críticamente sobre el impacto ambiental de la tecnología\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: informe crítico sobre uso social de IA en el entorno.\\
\end{tabularx}
...
\item Introducción a la Inteligencia Artificial: definición, historia y ejemplos cotidianos
\item Cómo aprenden las máquinas: Machine Learning básico — datos, patrones y predicciones
\item Sesgos algorítmicos: análisis crítico de algoritmos de recomendación en redes sociales
\item Ética y tecnología: impacto de la IA en el empleo, la privacidad y la equidad social
\item Instrumento de trabajo para el estudiante
\item Instrumento de trabajo para el estudiante
\item Gestión de RAEE: estrategias de reciclaje de componentes electrónicos — Rethink, Refuse, Reduce
\item Taller práctico: auditoría de e-waste institucional — identificación de dispositivos obsoletos
\item Proyecto MILC integrador: informe de impacto ambiental tecnológico con propuestas comunitarias
\item Tribunal analéctico: sustentación del proyecto ante panel y evaluación final de grado
\end{itemize}
\end{multicols}
...
Conceptos clave & Define IA y reconoce ejemplos de uso cotidiano: asistentes de voz, algoritmos de recomendación. Analiza la mochila ecológica de los dispositivos y el problema de la obsolescencia programada. Evalúa el impacto de la IA en el empleo, la privacidad y la equidad social.\\
...
Desempeño cognitivo & Define inteligencia artificial y Machine Learning básico con ejemplos contextualizados. Explica el ciclo de vida de un producto tecnológico desde la minería de tierras raras hasta la disposición final. Identifica los sesgos algorítmicos en redes sociales y sistemas de recomendación.\\
Desempeño procedimental & Investiga y documenta el funcionamiento de al menos tres aplicaciones de IA cotidianas. Realiza una auditoría de e-waste en la institución identificando dispositivos obsoletos. Elabora un informe sobre el impacto ambiental y social de los RAEE en su comunidad.\\
Desempeño actitudinal & Reflexiona críticamente sobre la responsabilidad ética del creador de tecnología. Promueve la cultura de reparación frente al reemplazo de dispositivos. Desarrolla compromiso con la sostenibilidad ambiental desde la gestión tecnológica.\\
\end{tabularx}

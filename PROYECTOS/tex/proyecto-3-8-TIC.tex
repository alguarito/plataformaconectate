...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Proyecto integrador · Grado 8}
...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-3-8-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 8 · Periodo Tercero}\\[1.0cm]
...
DBA del periodo & Crea contenidos multimedia y desarrolla conciencia crítica sobre seguridad en la red\\
...
Producto final & Prototipo, propuesta técnica o solución tecnológica con validación social. Puede dialogar con el producto antiguo sugerido: campaña escolar de ciberseguridad.\\
\end{tabularx}
...
\item Diseño de presentaciones multimedia: principios de comunicación visual y diseño de diapositivas
\item PowerPoint/Canva: animaciones de entrada, énfasis y salida — inserción de hipervínculos
\item Taller de diseño: creación de una presentación de alto impacto sobre un proyecto tecnológico
\item Edición básica de imagen: herramientas digitales para mejorar recursos visuales
\item Edición básica de sonido: captura, edición y exportación de audio para presentaciones
\item Seguridad en la red I: ciberbullying — definición, prevención y rutas de denuncia
\item Seguridad en la red II: sexting y grooming — estrategias de protección y conciencia digital
\item Estética de la liberación: crear contenidos que reflejen la belleza de la cultura popular
\item Proyecto MILC integrador: presentación multimedia sobre problemática social con enfoque ético
\item Sustentación pública y evaluación final — portafolio digital y bitácora estoica
\end{itemize}
\end{multicols}
...
Conceptos clave & Tema Central: Multimedia, Ciberseguridad y Estética de la Liberación\\

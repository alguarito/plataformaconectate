...
\begin{tcolorbox}[
  ...
  {\sffamily\bfseries\color{milcMostaza}\fontsize{25}{28}\selectfont proyecto-3-9-TIC}\\[8mm]
  {\sffamily\color{white}\Large Grado 9 · Periodo Tercero}\\[1.0cm]
...
DBA del periodo & Gestiona datos con funciones avanzadas de Excel y formula proyectos tecnológicos comunitarios\\
...
\item Excel intermedio I: funciones de búsqueda BUSCARV y BUSCARH — sintaxis y aplicación
\item Excel intermedio II: funciones lógicas avanzadas — SI anidado, Y, O, SI.ERROR
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
\item Gráficos estadísticos I: barras, líneas y circulares — selección del tipo adecuado según los datos
\item Gráficos estadísticos II: dispersión y combinados — interpretación de tendencias y patrones
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
\item Tema central del periodo: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible
...
Conceptos clave & Tema Central: Excel Intermedio, Gráficos y Proyecto Tecnológico — La Utopía Factible\\

...
% Tipografía: la fija franja.sty más abajo, con cortes reales de
% Newsreader y Bricolage Grotesque. Antes se sintetizaban la negrita y la
% cursiva engordando e inclinando Helvetica Neue.
...
% Paleta y tipografía vienen de tokens.json vía build-tokens.mjs. El
% paquete define además los alias heredados (vinoInst, azulInst,
% grisClaro…), de modo que el cuerpo del documento no cambia. El vino que
% este documento llamaba «institucional» era #6B1237; el institucional de
% verdad es #6B1A2A, y es el que se usa ahora.
\usepackage[fuentes=./fuentes/]{franja}
% Ejes curriculares (colores semánticos propios de este documento)
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\sffamily\small\color{vinoInst}\textbf{Plan de Área · Tecnología e Informática 2026}}
\fancyhead[R]{\sffamily\small\color{vinoInst}I.E. Sor María Juliana · Cartago}
\fancyfoot[L]{\sffamily\footnotesize\color{smjTinta3}Área de Tecnología e Informática}
\fancyfoot[C]{\sffamily\small\color{vinoInst}\textbf{\thepage}}
\fancyfoot[R]{\sffamily\footnotesize\color{smjTinta3}Cartago · Valle del Cauca}
...
\titleformat{\section}
  {\sffamily\Large\bfseries\color{vinoInst}}
  {\sffamily\colorbox{vinoInst}{\textcolor{white}{\rule[-2.5pt]{0pt}{13pt}\,\thesection\,}}}
  {0.6em}{}
  [{\color{lineGris}\titlerule[1.2pt]}]
\titlespacing*{\section}{0pt}{2.4ex plus 1ex minus .2ex}{1.4ex plus .2ex}
\titleformat{\subsection}
  {\sffamily\color{vinoInst}\normalsize\bfseries}{\sffamily\color{vinoInst!75!black}\thesubsection}{0.5em}{}
\titleformat{\subsubsection}
  {\sffamily\normalsize\bfseries}{\sffamily\color{vinoInst!70!black}\thesubsubsection}{0.5em}{}
...
\centering
{\color{dorado!88!white}\textbf{277 piezas curriculares activas}}\\[0.3cm]
{\small\color{white}216 del núcleo \,\textperiodcentered\, 61 en Territorio Interior, Semillero y Bebras}\\[0.16cm]
...
Y no es una promesa escrita al aire: detrás de cada página hay \textbf{\color{vinoInst}277
piezas ya construidas, probadas y publicadas} —216 del núcleo curricular, más 61
en los espacios que lo amplían— hechas para abrirse incluso \emph{sin señal},
porque ningún muchacho debería quedar afuera por no tener datos.
\end{minipage}
...
\hline
Núcleo curricular & 216 (180 guías + 18 proyectos integradores + 18 exámenes) \\
\hline
Espacios de ampliación & 61 (39 Territorio Interior + 12 Semillero + 10 Bebras) \\
\hline
Total piezas curriculares & 277 \\
\hline
...
\hfill
\tarjeta{Despliegue \textit{offline-first}}{Plataforma Conéctate: 277 piezas
—núcleo y ampliaciones— accesibles sin conexión permanente.}
...
\cifra{216}{piezas del núcleo}
\end{tcolorbox}

\smallskip
\noindent\begin{tcolorbox}[enhanced, colback=white, colframe=dorado, boxrule=0.8pt,
  arc=6pt, left=10pt, right=10pt, top=12pt, bottom=12pt]
\cifra{39}{Territorio Interior}\hfill%
\cifra{12}{Semillero}\hfill%
\cifra{10}{Bebras}\hfill%
\cifra{277}{piezas en total}
\end{tcolorbox}
...
\subsection{Los espacios que implementan los ejes}

Los dos ejes transversales declarados arriba no se sostienen solo con menciones
dentro de las guías de grado. Cada uno tiene un espacio propio en la plataforma,
con guías, secuencia y producto verificable. Nombrarlos aquí cierra el argumento:
el plan promete dos ejes y una apuesta por la investigación escolar, y estos son
los lugares donde eso ocurre.

\begin{center}
\begin{tabular}{|L{3.4cm}|L{2.6cm}|L{7.5cm}|}
\hline
\rowcolor{vinoInst}
\color{white}\textbf{Espacio} &
\color{white}\textbf{Piezas} &
\color{white}\textbf{A qué responde en este plan} \\
\hline
Núcleo curricular (G6°–G11°) &
216 &
Los 4 componentes MEN y las 4 fases MILC, desplegados en la malla de cada grado.
Es lo que cursa todo estudiante. \\
\hline
Territorio Interior &
39 de 60 &
El eje transversal de Habilidades Socioemocionales y los Lineamientos SEL
(sección\,2). Diez momentos por grado, con anclaje situado. \\
\hline
Semillero de Investigación &
12 de 20 &
La fase de \emph{Praxis} del modelo MILC llevada fuera del aula: cinco líneas de
cuatro módulos, con producto público. \\
\hline
Pruebas Bebras &
10 &
El eje transversal de Pensamiento Computacional y la meta 2026 de participación
en Bebras (sección\,8). \\
\hline
\end{tabular}
\end{center}

\noindent El núcleo es obligatorio; los tres espacios de ampliación se cursan por
interés y están abiertos a estudiantes de cualquier grado. Esa distinción importa:
no compiten con la malla, la extienden. El detalle vivo de cada uno —qué módulos
existen y cuáles faltan— se publica en la plataforma, no se congela en este
documento.
...
277 piezas interactivas (núcleo y ampliaciones), acceso offline \\
\hline
Suite IA &
...
\hline
Momentos de Territorio Interior & 39 \\
\hline
Módulos del Semillero & 12 \\
\hline
Guías de preparación Bebras & 10 \\
\hline
...
para un total de \textbf{216 piezas} en el núcleo curricular. Cada sesión
corresponde a una guía con su estructura MILC de 10 estaciones; cada periodo cierra
con un proyecto integrador y su examen. A ellas se suman las \textbf{61 piezas} de
los espacios de ampliación descritos en la sección\,7 —Territorio Interior, el
Semillero de Investigación y Bebras—, para un total de \textbf{277 piezas activas}
en la plataforma.

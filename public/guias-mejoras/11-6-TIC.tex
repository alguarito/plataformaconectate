...
\usepackage[hidelinks,
  pdftitle={Apertura periodo 2 — las máquinas que nos rodean por dentro},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 11 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Apertura\\[4pt]periodo 2 ---\\[4pt]las máquinas\\[4pt]que nos\\[4pt]rodean}\\[3.5mm]

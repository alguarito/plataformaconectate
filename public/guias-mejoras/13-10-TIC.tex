...
\usepackage[hidelinks,
  pdftitle={Google Docs para informes profesionales — estilos, índice y citas},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 10 · Guía 13 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Google Docs ---\\[4pt]estilos, índice\\[4pt]y citas profesionales}\\[3.5mm]

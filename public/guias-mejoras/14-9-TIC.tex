...
\textbf{Lo que va al cuaderno (Actividad 2 · ANALIZA).} Título: «Actividad 2 --- 3 principios del color editorial». \textbf{Formato:} 3 fichas, una por principio (contraste, jerarquía, accesibilidad), cada una con: definición en tus palabras + ejemplo de una de las 5 paletas de la Actividad 1 que lo cumple bien + ejemplo de algo que lo incumple. \textbf{Sabes que terminaste cuando} puedes diagnosticar problemas de color en cualquier diseño.
\end{infoband}

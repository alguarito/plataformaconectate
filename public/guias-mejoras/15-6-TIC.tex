...
\usepackage[hidelinks,
  pdftitle={Hardware vs software — el cuerpo y las instrucciones},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 15 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Hardware vs\\[4pt]software ---\\[4pt]el cuerpo\\[4pt]y las\\[4pt]instrucciones}\\[3.5mm]

...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Condicionales ---\\el si...\\entonces\\de los\\algoritmos}\\[4mm]
     {\sffamily\bfseries\fontsize{23}{26}\selectfont Guía 16-7-TIC}\\[2mm]
...
\checkbox Pensé en mi día normal.\\
\checkbox Anoté 6 decisiones reales.\\
\checkbox Las formulé en estructura SI-ENTONCES-SI NO.
...
\begin{softbox}{milcMostaza}{milcGris}{Estoicismo · Marco Aurelio (emperador de las decisiones diarias) · cuidado interior}

...
\usepackage[hidelinks,
  pdftitle={Mini-proyecto — informe técnico con datos reales y IA documentada},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 10 · Guía 19 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Mini-proyecto P2 ---\\[4pt]informe técnico\\[4pt]con datos reales}\\[3.5mm]

...
\usepackage[hidelinks,
  pdftitle={Microsoft 365 — conocer las herramientas del taller digital},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 7 · Guía 2 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Microsoft\\[4pt]365 ---\\[4pt]las herramientas\\[4pt]del taller\\[4pt]digital}\\[3.5mm]

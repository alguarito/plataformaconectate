...
\textbf{Lo que va al cuaderno (Actividad 2 · EXPLICA).} Título: «Actividad 2 --- Ruta del P3 + 5 reglas éticas». \textbf{Formato:} bloque A con la ruta del P3 (mitades). Bloque B con las 5 reglas éticas con palomita si te comprometes. \textbf{Extensión:} 15 líneas. \textbf{Sabes que terminaste cuando} podrías nombrar las 2 mitades y las 5 reglas sin abrir el cuaderno.
\end{infoband}

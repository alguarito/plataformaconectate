...
\usepackage[hidelinks,
  pdftitle={Apertura periodo 3 — el oficio de escribir y buscar con criterio},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 21 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Apertura\\[4pt]periodo 3 ---\\[4pt]escribir y\\[4pt]buscar con\\[4pt]criterio}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 21-6-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Respondí las 10 preguntas con honestidad.}
\milccheckrow{No copié ni le pregunté al compañero.}
\milccheckrow{Me detuve en las preguntas que me dieron duda.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Reflexión personal (mitad superior de la hoja).} Toma tu diagnóstico de Actividad 1 (las 10 preguntas) y \textbf{convierte las 10 respuestas en un párrafo reflexivo} de 5-6 líneas. Empieza con \emph{``Hoy en escritura digital yo...''} y termina con \emph{``Lo que quiero mejorar este periodo es...''}. No copies las respuestas: refléjalas. Esto te entrena en redactar tu propia voz.}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- Las 5 preguntas-radar del periodo (centro de la hoja).} Subtítulo: \textbf{``Mis 5 preguntas-radar del P3''}. Lista numerada de 5 preguntas que esperas resolver durante el periodo. Sugerencias para inspirarte (no copies estas, inventa tuyas): \emph{``¿Cómo escribo un documento que se vea profesional?''}, \emph{``¿Cómo busco información sin caer en publicidad?''}, \emph{``¿Cómo sé si una página dice verdad?''}, \emph{``¿Cómo cito fuentes correctamente?''}, \emph{``¿Cuántas veces al día debería revisar las fuentes que leo?''}.}
\milcpaso{3}{milcMagenta}{\textbf{Paso 3 --- Las 5 reglas éticas firmadas (mitad inferior).} Subtítulo: \textbf{``Mi compromiso ético del P3''}. Reproduce las 5 reglas (cita fuentes, verifica, no comparta sin verificar, respeta derechos, usa para sumar). Al lado de cada una, palomita ✓ si te comprometes. Si dudas con alguna, conversa con el profe antes de firmar.}
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Compromiso del oficio.} Debajo de las reglas, escribe esta frase en grande: \textbf{``Me comprometo a escribir con mi voz, no con voz prestada. A buscar con criterio, no con prisa.''}. Subráyala. Estos son los 2 pilares éticos del periodo 3.}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Sesión 1 con encabezado fijo.} En el cuaderno principal escribe el encabezado de la sesión 1: \emph{``Guía: 6° · Periodo 3 · Guía 1 --- Apertura. Fecha: \_\_/\_\_/2026''}. Debajo, anota qué hiciste en las 3 actividades (diagnóstico, ruta y reglas, compromiso).}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Firma y cierre.} Al final, firma con tu nombre completo y fecha. La próxima clase es \emph{S2: ¿Qué es un procesador de texto?}. Trae el cuaderno, trae las 5 preguntas en la cabeza, y ven listo a empezar a escribir digital.}

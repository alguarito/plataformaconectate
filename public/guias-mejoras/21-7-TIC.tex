...
\usepackage[hidelinks,
  pdftitle={Apertura periodo 3 — la IA como el nuevo consejero del barrio},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 7 · Guía 21 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Apertura\\[4pt]periodo 3 ---\\[4pt]la IA\\[4pt]como nuevo\\[4pt]consejero}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 21-7-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Imaginé la escena con calma.}
\milccheckrow{Respondí las 4 preguntas con honestidad.}
\milccheckrow{Pensé en las cualidades del consejero antiguo.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Índice del P3 + encabezado fijo.} En tu cuaderno de Tecnología, abre una nueva página. Título: \textbf{``Periodo 3 --- Inteligencia Artificial''}. Debajo, índice de 10 sesiones del P3 (de la ruta de la sistematización).}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- 5 acuerdos firmados.} En la siguiente hoja, reproduce los 5 acuerdos del uso responsable de IA. Al lado de cada uno, palomita ✓ si te comprometes. Si dudas con alguno, conversa con el profe.}
...
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Mini-investigación del consejero.} En la siguiente hoja, subtítulo: \textbf{``Mini-investigación: el consejero del barrio''}. Esta tarea la haces en casa: pregunta a una persona mayor de tu familia (mamá, papá, abuelos, tíos): \emph{``¿Quién era el consejero del barrio en su tiempo? ¿Qué tipo de consejos daba?''}. Apunta mínimo \textbf{5 datos concretos}: nombre del consejero, barrio o vereda, tipo de consejos, qué cualidades tenía, una historia concreta.}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Sesión 1 con encabezado fijo.} En el cuaderno principal escribe el encabezado de la sesión 1: \emph{``Guía: 7° · Periodo 3 · Guía 1 --- Apertura. Fecha: \_\_/\_\_/2026''}. Anota qué hiciste en las 3 actividades.}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Firma y cierre.} Al final firma con nombre completo y fecha. La próxima clase entras al primer concepto técnico: \emph{¿qué es la IA?}.}

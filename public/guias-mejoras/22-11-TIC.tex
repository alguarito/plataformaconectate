...
\usepackage[hidelinks,
  pdftitle={Validación — hablar antes de construir},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 11 · Guía 22 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Validación ---\\[4pt]hablar antes\\[4pt]de construir}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 22-11-TIC}
    };
\end{tikzpicture}
...
5 entrevistas a personas afectadas por el problema elegido en la sesión 1 (con guion de 7 preguntas + audio o notas + nombre y oficio del entrevistado) + síntesis de hallazgos en 1 página estructurada en 4 bloques (lo que confirmé, lo que descarté, lo que no esperaba, decisión de seguir o pivotar)
\end{tcolorbox}
...
\milccheckrow{Cerré lista de 5 entrevistados con nombre y oficio.}
\milccheckrow{Al menos 3 perfiles distintos (no entrevisté solo amigos).}
\milccheckrow{Cada entrevistado tiene día y hora tentativa esta semana.}

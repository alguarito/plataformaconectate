...
\usepackage[hidelinks,
  pdftitle={Google Sheets + IA para contabilidad personal o microempresa},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 10 · Guía 23 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Google Sheets + IA ---\\[4pt]contabilidad personal\\[4pt]o microempresa}\\[3.5mm]

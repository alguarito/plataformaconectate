...
\usepackage[hidelinks,
  pdftitle={Formato básico — darle voz visual a lo que escribo},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 23 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Formato\\[4pt]básico ---\\[4pt]darle\\[4pt]voz visual\\[4pt]a mi texto}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 23-6-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Note la diferencia clara entre las dos.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Abre tu documento.} Ve a la carpeta donde lo guardaste y haz doble clic. Si no lo encuentras, créalo de nuevo siguiendo S2 con 3 párrafos sobre un tema tuyo.}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- Formatea el título.} Selecciona el título (mantener clic izquierdo desde el inicio del título y arrastrar hasta el final). Aplica: \textbf{Ctrl+N (negrita)}, \textbf{Ctrl+E (centrar)}, cambia el \textbf{tamaño a 18} (en el cuadro de tamaño de la barra de arriba), y cambia el \textbf{color a azul oscuro} (en el menú de color de texto, escoge un azul que no sea fluorescente).}
\milcpaso{3}{milcMagenta}{\textbf{Paso 3 --- Formatea los párrafos.} Selecciona los 3 párrafos completos. Aplica: \textbf{Ctrl+J (justificar)}, asegúrate de que estén en \textbf{tamaño 12}, fuente \emph{Calibri} o \emph{Arial}, color \emph{negro}.}
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Resalta lo importante.} En cada uno de los 3 párrafos: identifica \textbf{1 palabra clave} y subráyala (selecciónala + Ctrl+S). Identifica \textbf{1 idea importante} (3-5 palabras) y ponla en negrita (selecciónala + Ctrl+N). En total tu documento tendrá 3 subrayados y 3 negritas. Ni más ni menos --- el énfasis se pierde si abusas.}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Sangría en primera línea.} En Word, para cada párrafo, presiona \texttt{Tab} al inicio del párrafo --- la primera línea queda con sangría (entra un poco hacia adentro). Esto se ve profesional. Lo haces para los 3 párrafos.}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Guarda y compara.} Pulsa \texttt{Ctrl+G}. El documento se actualiza. \textbf{Ahora compáralo con la versión que tenías en S2}. Mira la diferencia visual: la nueva versión se ve \emph{profesional}. En el cuaderno escribe: \emph{``Antes/Después: el cambio más notable es...''}.}

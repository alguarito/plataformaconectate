...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Tipos de\\IA --- estrecha,\\general y\\modelos\\especializados}\\[4mm]
     {\sffamily\bfseries\fontsize{23}{26}\selectfont Guía 23-7-TIC}\\[2mm]
...
\checkbox Leí las 8 apps con calma.\\
\checkbox Pensé qué hace la IA en cada una.\\
\checkbox Anoté mi intuición sin buscar.
...
Descomposición & \textbf{Paso 1 --- Tabla comparativa de 5 tipos.} En una hoja del cuaderno, tabla de \textbf{5 filas y 5 columnas}. Columnas: \emph{(1) Nombre del tipo}, \emph{(2) Qué hace}, \emph{(3) Ejemplo de app real}, \emph{(4) ¿Estrecha o general?}, \emph{(5) Algo que NO puede hacer}. Llena las 5 filas con los 5 tipos de la sistematización.\\
Patrones & \textbf{Paso 2 --- Análisis: ¿qué tipos uso más?} Debajo de la tabla, subtítulo: \textbf{``Los 3 tipos de IA que más uso''}. Lista numerada de 3 tipos en orden de frecuencia, con justificación corta: \emph{``Uso más [tipo] porque [actividad cotidiana]''}. Ejemplo: \emph{``1. Recomendadores, porque uso TikTok 3 horas al día. 2. Visión por computador, porque desbloqueo el celular 50 veces al día con cara. 3. LLMs, porque uso ChatGPT 5 veces a la semana.''}.\\
Abstracción & \textbf{Paso 3 --- Reflexión sobre AGI.} Subtítulo: \textbf{``Por qué la AGI todavía no existe''}. Escribe en 4-5 líneas tu propia explicación: por qué ChatGPT no es AGI, qué le falta a las IAs actuales para ser \emph{generales}, y si crees que llegará la AGI en tu vida (sí, no, no sé).\\
Algoritmo de armado & \textbf{Paso 4 --- Mapa visual.} En un costado, dibuja un \textbf{círculo grande} con la palabra \emph{IA}. Adentro divide en 5 sectores etiquetados con los 5 tipos (como pastel). Marca con sombreado cuáles usas TÚ regularmente. Esto te da imagen visual de tu uso.\\
\end{tabularx}
\normalsize
...
\begin{softbox}{milcMostaza}{milcGris}{Estoicismo · Marco Aurelio (emperador del análisis sereno) · cuidado interior}

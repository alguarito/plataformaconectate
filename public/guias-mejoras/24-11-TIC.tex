...
\usepackage[hidelinks,
  pdftitle={MVP digital — una versión imperfecta para probar},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 11 · Guía 24 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}MVP digital ---\\[4pt]una versión imperfecta\\[4pt]para probar}\\[3.5mm]

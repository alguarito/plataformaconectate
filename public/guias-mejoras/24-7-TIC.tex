...
\usepackage[hidelinks,
  pdftitle={Cómo aprende una IA — datos, entrenamiento y el problema del sesgo},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 7 · Guía 24 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Cómo aprende\\[4pt]una IA ---\\[4pt]datos,\\[4pt]entrenamiento\\[4pt]y sesgo}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 24-7-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Imaginé el experimento de entrenar la IA.}
\milccheckrow{Respondí las 5 preguntas con calma.}
\milccheckrow{Identifiqué que los datos importan, no solo cantidad.}
...
\milcpaso{1}{milcTurquesa}{\textbf{Las 4 partes del aprendizaje de una IA.} \textbf{(1) Datos de entrenamiento.} Miles o millones de ejemplos. Para ChatGPT: textos de libros, Wikipedia, foros, sitios web. Para una IA médica: historiales clínicos. Para reconocimiento facial: fotos de personas con sus nombres. \textbf{Calidad de los datos = calidad de la IA}. Datos sesgados → IA sesgada. \textbf{(2) Algoritmo de aprendizaje.} La fórmula matemática que ajusta el modelo. La más usada hoy: \emph{redes neuronales profundas} (deep learning), inspiradas en cómo funcionan las neuronas del cerebro humano. Otras: árboles de decisión, regresión, máquinas de soporte vectorial.}
\milcpaso{2}{milcTurquesa}{\textbf{Las 4 partes (continuación).} \textbf{(3) Modelo entrenado.} El resultado del proceso: un conjunto de \emph{parámetros} (números) que el algoritmo ajustó. \emph{La IA misma}. GPT-4 tiene aproximadamente 1.7 trillones de parámetros. Cada uno es un número ajustado durante el entrenamiento. \textbf{(4) Predicción/generación.} Cuando le das una entrada nueva, el modelo la procesa y produce una salida. \emph{El uso real}. Para ChatGPT: tú escribes pregunta, modelo genera respuesta. Para reconocedor facial: tú muestras foto, modelo dice quién es.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Dibuja el diagrama del aprendizaje.} En una hoja del cuaderno, dibuja un diagrama horizontal con \textbf{4 cajas conectadas por flechas}: \emph{Datos → Algoritmo → Modelo → Predicción}. Adentro de cada caja, una descripción breve (1-2 líneas) de qué pasa ahí.}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- Análisis de los 3 casos reales.} Debajo del diagrama, tabla de \textbf{3 filas y 4 columnas}. Columnas: \emph{(1) Caso}, \emph{(2) ¿Qué pasó?}, \emph{(3) ¿Por qué? (sesgo en datos)}, \emph{(4) ¿Cuál fue la consecuencia?}. Filas: Amazon CV, Google Photos, COMPAS.}
\milcpaso{3}{milcMagenta}{\textbf{Paso 3 --- Tu mini-ejemplo de sesgo.} Inventa un caso simple. Ejemplo: \emph{``Una IA para clasificar canciones colombianas se entrena solo con vallenato. Después se le muestra una salsa choke. ¿Qué pasa? La IA dice 'no es música colombiana' porque no aprendió otros géneros''}. Describe tu caso en 3-4 líneas: \emph{(a) qué se quiere lograr}, \emph{(b) qué datos usaron}, \emph{(c) cómo se manifiesta el sesgo}, \emph{(d) qué solución propondrías}.}
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Las 5 reglas para detectar sesgo.} Lista numerada del 1 al 5. Reproduce las 5 reglas que aprendiste, con tus palabras. Subráyalas: serán tu kit mental para evaluar cualquier IA que uses.}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Aplicación: prueba una IA que uses regularmente.} Escoge una IA (TikTok, Google Translate, ChatGPT). Aplica las 5 reglas mentalmente. Identifica al menos 1 posible sesgo. Anota: \emph{``IA evaluada: \_\_\_. Posible sesgo detectado: \_\_\_. Cómo lo verificaría: \_\_\_''}.}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Reflexión personal + firma.} Al final escribe en 3-4 líneas: \emph{``Lo que más me sorprendió de este tema fue \_\_\_. Antes pensaba que la IA era neutral, ahora sé que \_\_\_. La regla más útil para mí es \_\_\_''}. Firma con nombre y fecha.}

...
\usepackage[hidelinks,
  pdftitle={Tablas e imágenes — mostrar datos y agregar voz visual},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 25 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Tablas e\\[4pt]imágenes ---\\[4pt]mostrar datos\\[4pt]y agregar\\[4pt]voz visual}\\[3.5mm]

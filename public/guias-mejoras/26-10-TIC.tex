...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Encuestas y análisis\\de mercado\\con IA}\\[4mm]
     {\sffamily\bfseries\fontsize{23}{26}\selectfont Guía 26-10-TIC}\\[2mm]
...
\checkbox Tuve conversación de 5-10 min con 1 persona.\\
\checkbox Hice las 5 preguntas con naturalidad.\\
\checkbox Anoté las respuestas textuales.

...
Antes del gráfico de barras existieron \textbf{los mapas grabados en piedra} de los pueblos andinos para mostrar caminos y cosechas; los \textbf{dibujos en arena} de los pescadores afro-pacíficos para explicar corrientes y zonas de pesca; los \textbf{esquemas de la abuela campesina} dibujados en el suelo con un palo para mostrar el patrón del año productivo; los \textbf{tejidos Wayuu} cuyos rombos y triángulos cuentan historias de tribu. Visualizar datos es un gesto humano antiguo. El software no inventó la gráfica: cambió el medio y la velocidad, pero la pregunta sigue siendo la misma --- \emph{¿cómo le muestro a otro lo que yo ya vi en los números?}
\end{softbox}
...
\textbf{Lo que va al cuaderno (Actividad 2 · ANALIZA).} Título: «Actividad 2 --- Anatomía de un gráfico». \textbf{Formato:} 3 fichas, una por tipo (barra, línea, circular), cada una con: pregunta que responde + cuándo elegirlo + cuándo NO elegirlo + 1 error frecuente. \textbf{Sabes que terminaste cuando} podrías elegir el tipo de gráfico adecuado para cualquier pregunta sin consultar.
\end{infoband}

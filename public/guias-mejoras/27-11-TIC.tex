...
\usepackage[hidelinks,
  pdftitle={Presupuesto — cuánto siembras, cuánto cosechas},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 11 · Guía 27 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Presupuesto ---\\[4pt]cuánto siembras,\\[4pt]cuánto cosechas}\\[3.5mm]

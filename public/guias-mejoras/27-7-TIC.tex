...
\textbf{Lo que va al cuaderno (Actividad 2 · EXPLICA).} Título: «Actividad 2 --- 4 técnicas + combinaciones». \textbf{Formato:} tabla de 4 filas, 3 columnas (técnica, cuándo usarla, ejemplo). + 3 combinaciones poderosas. \textbf{Extensión:} 7 líneas. \textbf{Sabes que terminaste cuando} puedes recomendar la técnica correcta para cualquier tarea.
\end{infoband}
...
\begin{softbox}{milcMostaza}{milcGris}{Estoicismo · Marco Aurelio (emperador de las habilidades refinadas) · cuidado interior}

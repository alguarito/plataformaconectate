...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Comunicación\\empresarial profesional\\con IA}\\[4mm]
     {\sffamily\bfseries\fontsize{23}{26}\selectfont Guía 28-10-TIC}\\[2mm]
...
\checkbox Tomé propuesta de valor del Canvas.\\
\checkbox La reduje a 1 frase de máximo 20 palabras.\\
\checkbox La frase incluye producto, cliente, problema, diferencial.

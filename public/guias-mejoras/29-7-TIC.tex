...
\textbf{Lo que va al cuaderno (Actividad 2 · EXPLICA).} Título: «Actividad 2 --- 4 legítimos + 4 trampa + atribución». \textbf{Formato:} bloque A con 4 legítimos (cada uno: descripción + ejemplo). Bloque B con 4 no legítimos. Bloque C con plantilla de atribución. Bloque D con las 5 preguntas de autoevaluación. \textbf{Extensión:} 18 líneas. \textbf{Sabes que terminaste cuando} podrías evaluar cualquier uso de IA en tareas con criterio.
\end{infoband}

...
2. Reconocimiento de patrones & \textbf{Reconocimiento de patrones.} Todo sitio sigue un patrón heredado del periódico impreso: \textbf{header arriba}, \textbf{footer abajo}, \textbf{main en el centro} con secciones temáticas. La razón es psicológica: el ojo del lector occidental escanea de arriba a abajo y de izquierda a derecha. Romper ese patrón sin razón cuesta clics y atención. La buena variación (un sidebar fijo, un hero a pantalla completa) es excepción justificada, no regla.\\
3. Abstracción & \textbf{Abstracción.} Lo esencial de una página cabe en su \emph{esqueleto semántico}: si abres tu HTML en el navegador sin CSS y todavía se lee como un documento ordenado (un h1 claro, h2 que estructuran, párrafos, listas), tu abstracción está bien. Ese ``test sin estilos'' es el que usan los lectores de pantalla, los buscadores y los archivos del futuro. Si tu sitio depende de CSS para tener sentido, tu HTML está mal pensado.\\
4. Algoritmo conceptual & \textbf{Algoritmo.} (1) Dibuja a mano la jerarquía en papel (header / nav / main / footer); (2) decide qué \texttt{section}s irán dentro del main y nómbralas; (3) traduce el esquema a HTML semántico sin pensar en estilos; (4) prueba el resultado en el navegador \emph{sin CSS} --- si se entiende, hiciste bien; (5) recién después agrega los estilos. Diseñar el HTML antes que el CSS es el orden correcto, aunque parezca al revés.\\
\end{tabularx}
\normalsize

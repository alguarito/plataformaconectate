...
\usepackage[hidelinks,
  pdftitle={OneDrive — mi nube personal y mi cuarto de archivos},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 7 · Guía 3 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}OneDrive ---\\[4pt]mi nube\\[4pt]personal y\\[4pt]cuarto de\\[4pt]archivos}\\[3.5mm]

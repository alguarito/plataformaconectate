...
\usepackage[hidelinks,
  pdftitle={Sustentación pública — el aprendiz frente a los mayores},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 11 · Guía 30 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Sustentación pública ---\\[4pt]el aprendiz\\[4pt]frente a los mayores}\\[3.5mm]

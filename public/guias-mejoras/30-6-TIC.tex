...
\usepackage[hidelinks,
  pdftitle={Mi primer documento informativo — producto que reúne todo lo aprendido},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 30 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Mi primer\\[4pt]documento\\[4pt]informativo ---\\[4pt]todo lo\\[4pt]aprendido}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 30-6-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Respondí las 3 preguntas con honestidad.}
\milccheckrow{Elegí un tema que me interese, no uno aburrido.}
\milccheckrow{Tengo 4 puntos clave para desarrollar.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Investiga (10 min).} Aplica S8 (búsquedas con operadores) y S9 (CRAAP) para encontrar 3 fuentes sobre tu tema. Anota los enlaces o nombres en el cuaderno. Para cada una, evalúa CRAAP rápido (notas de 0 a 5 en los 5 criterios). Quédate con las 2-3 que mejor califiquen.}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- Crea el documento + portada (8 min).} Abre Word/Docs. \textbf{Portada (página 1):} título grande centrado tamaño 28 en negrita azul oscuro, tu nombre, grado, materia (Tecnología), fecha. Estética simple. \texttt{Ctrl+Enter} para saltar a página 2.}
\milcpaso{3}{milcMagenta}{\textbf{Paso 3 --- Páginas 2 y 3: contenido (25 min).} En página 2: \textbf{encabezado} con tu nombre + grado + materia (tamaño 10, alineación derecha). \textbf{Título de sección}: nombre del tema en tamaño 16 negrita. Escribe 2 párrafos justificados con sangría. Inserta 1 \textbf{imagen} de fuente libre (Pixabay) con ajuste cuadrado + pie en cursiva tamaño 10. En página 3: continúa con 2 párrafos más, 1 \textbf{lista} (con viñetas o numerada), 1 \textbf{tabla} (mínimo 3 filas, encabezado en negrita). Aplica énfasis controlado.}
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Pie de página + numeración (3 min).} En cualquiera de las páginas 2 o 3, inserta pie de página: \emph{``I.E. Sor María Juliana --- Cartago --- Mayo 2026''}. Inserta números de página en esquina inferior derecha. Configura para que la portada no se numere (la página 1 es la página de contenido, no la portada).}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Sección de fuentes citadas (4 min).} Al final de la página 3, escribe el subtítulo \textbf{``Fuentes citadas''}. Debajo, lista las 3 fuentes en formato simple: \emph{``Apellido, Nombre. Título del artículo. Nombre del sitio. Año. URL.''}. Si no tienes todos los datos, escribe los que sí tengas. Al lado de cada fuente, en cursiva, escribe la nota CRAAP (\emph{Total: 22/25}, por ejemplo).}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Autoevaluación + guardado (5 min).} En el cuaderno, marca con palomita ✓ los 10 elementos que SÍ aplicaste, y con X los que faltan. Cuenta tu nota: cada elemento aplicado vale 1 punto (sobre 10). Guarda el documento como \texttt{2026-cosecha-p3-mi-tema.docx} en \emph{Tecnologia/Periodo-3}. Firma en el cuaderno con la frase: \emph{``Terminé el periodo 3 con un documento que prueba todo lo que ahora sé hacer.''}.}

...
\usepackage[hidelinks,
  pdftitle={Cosecha del periodo 3 — mi proyecto con IA responsable},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 7 · Guía 30 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Cosecha\\[4pt]del periodo 3 ---\\[4pt]mi proyecto\\[4pt]con IA\\[4pt]responsable}\\[3.5mm]

...
\usepackage[hidelinks,
  pdftitle={Portada con IA generativa de imagen — herramientas gratuitas},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 10 · Guía 7 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Portada con IA ---\\[4pt]herramientas gratuitas\\[4pt]para generar imagen}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Guía 7-10-TIC}
    };
\end{tikzpicture}
...
\milccheckrow{Elegí 3 portadas que recuerdo.}
\milccheckrow{Respondí 4 preguntas sobre cada una.}
\milccheckrow{Identifiqué qué las hace memorables.}
...
\milcpaso{1}{milcMagenta}{Tu portada se construye en 6 pasos: (1) escribir 3 prompts visuales distintos para tu libro (3 enfoques: realista, ilustrado, conceptual). (2) probar cada uno en al menos 1 herramienta (Bing Image Creator es buen primer paso). (3) generar 3-4 imágenes por prompt. (4) elegir las 3 mejores en total. (5) decidir la versión definitiva con criterio editorial (¿cuál representa mejor el libro?). (6) llevar la imagen elegida a Canva o Microsoft Designer y agregar título grande, autor más pequeño, en composición final.}
\milcpaso{2}{milcMagenta}{Sigue el patrón \textbf{``imagen IA + composición humana''}: la imagen pura de la IA rara vez es portada final. Necesita agregarse título legible, nombre del autor, posiblemente subtítulo. Esa composición es trabajo humano del editor con herramientas gratuitas (Canva, Designer, Express). La portada final es la unión de imagen generada con composición curada.}
\milcpaso{3}{milcMagenta}{La decisión justificada por escrito tiene 3 puntos: (a) cuál elegí, (b) por qué representa mejor el libro, (c) qué descarté de las otras dos y por qué. 1 párrafo total. Esta justificación demuestra criterio editorial, no aceptación pasiva de la IA.}
\milcpaso{4}{milcMagenta}{Algoritmo: (1) escribir 3 prompts. (2) generar imágenes. (3) elegir 3 mejores. (4) decidir definitiva. (5) componer con título y autor. (6) justificar decisión. (7) declarar modelo usado y respetar términos de uso de la herramienta.}

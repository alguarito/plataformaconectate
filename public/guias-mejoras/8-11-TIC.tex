...
\usepackage[hidelinks,
  pdftitle={Perfiles profesionales — LinkedIn y portafolio coherentes},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 11 · Guía 8 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Perfiles profesionales ---\\[4pt]LinkedIn y portafolio\\[4pt]coherentes}\\[3.5mm]

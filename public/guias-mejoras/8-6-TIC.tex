...
\textbf{Lo que va al cuaderno (Actividad 2 · EXPLICA).} Título: «Actividad 2 --- Las 5 señales y mis 3 acciones». \textbf{Formato:} 2 partes. Parte A: las 5 señales numeradas con \emph{tu propia explicación de qué significa cada una} (1 línea por señal). Parte B: las 3 acciones de oro escritas con tus palabras. \textbf{Extensión:} 8 líneas en total. \textbf{Sabes que terminaste cuando} podrías recitarlas todas sin abrir el cuaderno.
\end{infoband}
...
\begin{softbox}{milcMostaza}{milcGris}{Estoicismo · Séneca (filósofo romano que escribió sobre el miedo) · cuidado interior}

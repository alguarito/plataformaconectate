...
\milcpaso{4}{milcTurquesa}{\textbf{Algoritmo.} Pasos semanales: (1) lunes 7 p. m., abrir el dashboard; (2) anotar las 5 cifras de la semana en el cuaderno; (3) compararlas con la semana anterior (no en absoluto, sino en tendencia: \texttt{+}, \texttt{-}, \texttt{=}); (4) identificar una sorpresa (algo que no esperabas); (5) escribir 1 decisión concreta y accionable que tomarás esta semana basada en esos datos; (6) cerrar el dashboard hasta el próximo lunes --- la disciplina semanal vence al refresh diario.}
...
\textbf{Para la próxima semana.} Lunes a las 7 p. m., dedica 15 minutos a leer tu dashboard y escribir 1 decisión accionable. No mires los datos entre semana. Que la disciplina sea semanal, no diaria. El próximo lunes traes el cuaderno con esa lectura.
\end{infoband}

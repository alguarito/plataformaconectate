...
\usepackage[hidelinks,
  pdftitle={Comunicación responsable — los 3 filtros antes de publicar},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Grado 6 · Guía 9 · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Comunicación\\[4pt]responsable ---\\[4pt]los 3 filtros\\[4pt]antes de\\[4pt]publicar}\\[3.5mm]

...
\textbf{Lo que va al cuaderno (Actividad 2 · EXPLICA).} Título: «Actividad 2 --- Outlook vs Teams vs WhatsApp». \textbf{Formato:} tabla de 5 filas, 3 columnas. Filas: \emph{(1) ¿Para qué?}, \emph{(2) Formalidad}, \emph{(3) Queda registrado}, \emph{(4) Ejemplo de uso}, \emph{(5) Cuándo NO usar}. \textbf{Extensión:} 5 filas × 3 columnas. \textbf{Sabes que terminaste cuando} podrías recomendar el canal correcto para 5 situaciones distintas.
\end{infoband}

...
\usepackage[hidelinks,
  pdftitle={Parte y vencerás: la descomposición como primera pieza del pensamiento computacional},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Bebras · Momento 1 · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Momento 1 · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Parte y vencerás --- la descomposición\\[4pt]como primera pieza del pensamiento computacional}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Bebras · Momento 1}
    };
\end{tikzpicture}
...
\milccheckrow{Nombraste la tarea grande y la partiste en al menos cuatro partes pequeñas y concretas.}
\milccheckrow{Señalaste cuáles partes pueden hacerse al mismo tiempo (en paralelo) y cuáles deben ir en orden.}
\milccheckrow{Identificaste qué parte hay que terminar primero para que las demás puedan avanzar.}
...
\milcpaso{1}{milcTurquesa}{\textbf{Descomposición (esta pieza):} parte el problema grande en partes pequeñas, resuelve cada una por separado y combina las soluciones. Organizar el bazar del colegio se vuelve: decoración, comida, música y recaudo --- cuatro partes que sí caben en las manos.}
\milcpaso{2}{milcTurquesa}{\textbf{Reconocer patrones:} busca lo que se repite para no resolver lo mismo dos veces. Si cada mañana tardas el mismo tiempo en alistar el morral, ya puedes predecir cuándo salir sin mirar el reloj.}
\milcpaso{3}{milcTurquesa}{\textbf{Abstracción:} quédate con los datos que cambian la respuesta e ignora el resto. Cuando partes el bazar en áreas, no necesitas saber el color exacto de cada globo: solo cuántos equipos hay y qué hace cada uno.}
\milcpaso{4}{milcTurquesa}{\textbf{Algoritmo:} escribe los pasos exactos en el orden correcto. Una vez que tienes las partes identificadas, el algoritmo dice en qué orden atacarlas: primero lo que desbloquea lo demás, luego lo que puede ir en paralelo, al final el ensamble.}
...
\milcpaso{1}{milcMagenta}{\textbf{Descomposición:} parte el enunciado. ¿Cuántas partes hay? ¿Qué hace cada una? ¿Son independientes o una depende de otra?}
\milcpaso{2}{milcMagenta}{\textbf{Patrones:} busca si algo se repite --- una regla de conteo, una estructura que se repita en filas o columnas.}
\milcpaso{3}{milcMagenta}{\textbf{Abstracción:} ignora los datos de adorno; quédate con los números y relaciones que cambian la respuesta.}
\milcpaso{4}{milcMagenta}{\textbf{Algoritmo:} escribe, en orden, los pasos que te llevan del enunciado a la respuesta, sin saltarte ninguno.}

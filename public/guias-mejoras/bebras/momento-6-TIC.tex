...
\usepackage[hidelinks,
  pdftitle={Verdadero o falso: lógica, deducción y acertijos de grilla},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Bebras · Momento 6 · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Momento 6 · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Verdadero o falso --- lógica,\\[4pt]deducción y acertijos de grilla}\\[3.5mm]

...
\usepackage[hidelinks,
  pdftitle={Grafos y optimización: nodos, conexiones, el camino más corto},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Tecnología e Informática · Bebras · Momento 7 · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Momento 7 · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Grafos y optimización --- nodos,\\[4pt]conexiones, el camino más corto}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Bebras · Momento 7}
    };
\end{tikzpicture}
...
Tu grafo de la red de rutas desde tu casa (con nodos, conexiones y tiempos) más la evaluación de dos rutas con criterios propios y el simulacro de tres retos estilo Bebras resueltos y justificados.
\end{tcolorbox}
...
\milccheckrow{Identificaste al menos tres lugares distintos que visitas con frecuencia (nodos).}
\milccheckrow{Señalaste al menos dos caminos directos entre esos lugares (conexiones).}
\milccheckrow{Reconociste un punto de decisión donde puedes ir por más de una ruta posible.}
...
\milcpaso{1}{milcTurquesa}{\textbf{Nodo:} un punto de la red. Puede ser una ciudad, una vereda, una parada de bus, una persona o un sitio web. En el grafo del Pacífico, cada caserío es un nodo; en el mapa de Cartago, cada parada de bus.}
\milcpaso{2}{milcTurquesa}{\textbf{Conexión (arista):} una línea que une dos nodos. Puede tener un \emph{peso} --- tiempo, distancia, costo --- o no. El tramo de río entre dos caseríos es una conexión con peso (tiempo en canoa); una amistad en redes sociales es una conexión sin peso.}
\milcpaso{3}{milcTurquesa}{\textbf{Camino:} una secuencia de nodos unidos por conexiones. Entre dos nodos puede haber varios caminos distintos; la tarea es encontrar el más conveniente según el criterio que importa --- el más corto, el más barato, el más rápido.}
\milcpaso{4}{milcTurquesa}{\textbf{Optimizar:} elegir la mejor opción según un criterio claro. Optimizar no es adivinar: es comparar los caminos posibles y argumentar cuál gana. En Bebras, casi siempre se pide el camino de \emph{menor peso total}.}
...
\milcpaso{1}{milcMagenta}{\textbf{Identifica los nodos y conexiones:} nombra cada punto de la red y cada camino que existe entre ellos.}
\milcpaso{2}{milcMagenta}{\textbf{Anota los pesos:} escribe el número de cada conexión (tiempo, distancia u otro). Sin los pesos no puedes comparar.}
\milcpaso{3}{milcMagenta}{\textbf{Lista todos los caminos posibles} entre origen y destino, sin saltarte ninguno.}
\milcpaso{4}{milcMagenta}{\textbf{Suma y compara:} calcula el peso total de cada camino y elige el de menor suma. Ese es el camino óptimo.}

...
\begin{tikzpicture}[scale=0.92,>=stealth,font=\sffamily]
  ...
  % ── Moraleja ─────────────────────────────────────────────────────────
  \node[font=\scriptsize\itshape,milcNegro!75,align=center,text width=8.6cm]
    at (0,-1.95)
    {Con solo dos números --- \textbf{altura} y \textbf{azimut} --- cualquier persona
     del mundo apunta al mismo pedazo de cielo que tú.};

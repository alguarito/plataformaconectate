...
\begin{tikzpicture}[scale=1,font=\sffamily]
  ...
  % ── Moraleja ─────────────────────────────────────────────────────────
  \node[font=\scriptsize\itshape,milcNegro!75,align=center,text width=10.5cm]
    at (5.5,-0.85)
    {Un planeta que pasa por delante de su estrella le tapa un poquito la luz: el
     brillo baja $\sim 1\%$ y vuelve. \textbf{Ese bajón simétrico ---no una foto del
     planeta--- es como se descubre la mayoría de los exoplanetas.}};

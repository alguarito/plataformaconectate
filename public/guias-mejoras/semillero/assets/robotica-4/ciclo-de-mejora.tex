...
\begin{tikzpicture}[scale=1,font=\sffamily,>=stealth]
  ...
  \node[font=\scriptsize\itshape,milcNegro!75,align=center,text width=11cm]
    at (0,-3.55)
    {Mejorar no es rehacer todo: es girar este ciclo. Cada vuelta cambia
     \textbf{una} cosa y la comprueba, para saber con evidencia qué la mejoró
     ---no con suerte. Un aparato que nunca falló en la prueba probablemente no
     se probó bien.};

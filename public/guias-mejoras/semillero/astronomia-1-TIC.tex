% TEMPLATE-MILC-v3-SEMILLERO.tex - variante para el Semillero de Investigacion.
% Igual que template-milc-v3-conectate.tex (incluye el motor de recursos:
% \guiaFigura / \guiaDiagrama) salvo portada y encabezado: el Semillero no
% esta atado a grado/periodo, sino a LINEA + MODULO + fase MILC.
% Driver: scripts/build-guias-semillero.py
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Sin el circulito de grado (°) del template de grados: aqui el numero grande
  % es el MODULO del itinerario, no un grado escolar. «Modulo 1», no «1°».

  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Mirar el cielo\\de Cartago ---\\de las Cabrillas del abuelo\\a la observación\\con método}\\[4mm]
...
\checkbox Respondí las 2 preguntas del círculo en voz alta.\\
\checkbox Anoté al menos 3 señales del cielo que usan (o usaban) en mi familia o mi vereda.\\
\checkbox Mi inventario tiene las 3 columnas llenas, incluida la de «nunca lo he visto».
...
\textit{````El saber del oprimido no es ausencia de saber: es un saber que fue negado.''''}

Durante 400 años, el pronóstico del abuelo campesino fue \emph{``creencia de viejos''} --- hasta que una revista del norte lo publicó y entonces \textbf{sí} fue conocimiento. Dussel te obliga a preguntar: \textbf{¿el saber del abuelo empezó a ser cierto en el 2000, o siempre lo fue y solo empezamos a escucharlo?}. La ciencia no le \emph{dio} la razón: \textbf{le reconoció} una razón que ya tenía. Cuando esta noche abras tu bitácora, estás haciendo lo mismo que hacía él, con otro lenguaje. \textbf{Tu cielo, el de Cartago, es un cielo con dueños de saber que casi nadie ha citado}.
...
\begin{softbox}{milcMostaza}{milcGris}{Estoicismo · Marco Aurelio (Meditaciones, VII, 47) · cuidado interior}
\textit{````Contempla el curso de los astros como si giraras con ellos.''''}

Marco Aurelio escribió eso siendo emperador, en campaña, entre guerras y pestes: \textbf{levantar los ojos era su forma de recuperar la proporción}. No decía \emph{``mira el cielo para distraerte''}; decía \emph{gira con él} --- ponte adentro, reconoce que eres parte de lo que observas. Esta noche vas a estar 20 minutos a oscuras, sin pantalla, esperando que tu pupila se abra. \textbf{Esa espera incómoda es la mitad del ejercicio}: el cielo no se le entrega al afanado. \emph{La disciplina del observador es, antes que técnica, una disciplina del tiempo.}
...
\textit{````Lo que no se registra, no existe para el conocimiento.''''}

Miles de personas en Cartago van a mirar el cielo esta noche. \textbf{Casi ninguna va a producir un solo dato}, porque mirar sin registrar \textbf{no deja rastro en la infoesfera}. La diferencia entre un paseo y una observación es \textbf{una libreta}. Floridi diría que tu bitácora es un acto de creación: conviertes \textbf{luz} en \textbf{información}, y esa información ya puede compararse, discutirse y refutarse. \emph{El abuelo registraba en la memoria y en la palabra; tú registras en papel; la NASA registra en píxeles.} \textbf{Los tres hacen lo mismo}: sostener lo visto para que no se lo lleve la noche.

...
\usepackage[hidelinks,
  pdftitle={Datos que hablan del cielo — de las cabañuelas del abuelo a la curva de luz},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Semillero de Investigación · Astronomía y ciencia ciudadana · Módulo 2 · Sistematización · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Datos que hablan\\[4pt]del cielo ---\\[4pt]de las cabañuelas del abuelo\\[4pt]a la curva de luz}\\[3.5mm]

...
\usepackage[hidelinks,
  pdftitle={Comunicar y cuidar el conocimiento — de la palabra que caminan los Misak al póster honesto},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Semillero de Investigación · Astronomía y ciencia ciudadana · Módulo 4 · Evaluación liberadora · MILC v3},
  pdflang={es-CO},
...
\lhead{\small Semillero de Investigación · Astronomía y ciencia ciudadana\\[-1pt]{\footnotesize\strut}}
\rhead{\small Módulo 4 · Evaluación liberadora · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Comunicar y cuidar\\[4pt]el conocimiento ---\\[4pt]de la palabra que\\[4pt]caminan los Misak\\[4pt]al póster honesto}\\[3.5mm]
...
\milccheckrow{Ubiqué frases en su peldaño de la escalera de la certeza.}
\milccheckrow{Puedo explicar por qué exagerar un hallazgo es como «perder la palabra».}
\milccheckrow{Escribí qué puede y qué NO puede afirmar mi propia evidencia.}

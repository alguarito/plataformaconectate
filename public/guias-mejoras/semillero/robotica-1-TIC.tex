...
\usepackage[hidelinks,
  pdftitle={Cosas que podrían reaccionar — del sapo que anuncia la lluvia al sensor que percibe},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Semillero de Investigación · Robótica y sistemas embebidos · Módulo 1 · Escucha · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Módulo 1 · Escucha · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}

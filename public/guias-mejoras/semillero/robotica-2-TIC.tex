...
\usepackage[hidelinks,
  pdftitle={De la idea al pseudocódigo — de la cera perdida de los Quimbaya al diagrama de flujo},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Semillero de Investigación · Robótica y sistemas embebidos · Módulo 2 · Sistematización · MILC v3},
  pdflang={es-CO},
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}De la idea al pseudocódigo ---\\[4pt]de la cera perdida\\[4pt]de los Quimbaya\\[4pt]al diagrama de flujo}\\[3.5mm]

...
\usepackage[hidelinks,
  pdftitle={Construir y programar en MakeCode — del potro emberá probado en el río al prototipo probado},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Semillero de Investigación · Robótica y sistemas embebidos · Módulo 3 · Praxis · MILC v3},
  pdflang={es-CO},
...
\lhead{\small Semillero de Investigación · Robótica y sistemas embebidos\\[-1pt]{\footnotesize\strut}}
\rhead{\small Módulo 3 · Praxis · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Construir y programar\\[4pt]en MakeCode ---\\[4pt]del potro emberá\\[4pt]probado en el río\\[4pt]al prototipo probado}\\[3.5mm]
...
\milccheckrow{Puedo explicar por qué «se ve bien» no es lo mismo que «funciona».}
\milccheckrow{Emparejé cada figura del diagrama de flujo con su bloque de MakeCode.}
\milccheckrow{Anoté, sobre mi diagrama del módulo 2, qué bloque le toca a cada figura.}
...
\guiaDiagrama{assets/robotica-3/flujo-a-bloques.tex}{El programa del fotómetro, tal como se arma en MakeCode (bloques y etiquetas reales del entorno). Programar en el módulo 3 no es inventar: es traducir el plano del módulo 2 —cada figura del diagrama de flujo tiene su bloque, como muestra la leyenda de abajo. Si el plano estaba bien, la traducción sale sola.}
...
\milcpaso{1}{milcMagenta}{\textbf{Paso 1 --- Traduce el plano a bloques (25 min).} Abre \emph{makecode.microbit.org} con tu diagrama de flujo del módulo 2 al lado. Arma, figura por figura: el bucle \textbf{«por siempre»}, la \textbf{variable} con la lectura del sensor, la estructura \textbf{«si\ldots si no»} con tu umbral, y los \textbf{actuadores} (mostrar ícono/número, sonido). Prueba en el \textbf{simulador} moviendo el sensor en pantalla mientras armas. \textbf{No inventes lógica nueva:} si algo no encaja, el problema suele estar en el plano ---vuelve a él, no improvises.}
\milcpaso{2}{milcMagenta}{\textbf{Paso 2 --- Calibra con medidas reales (10 min).} Con el micro:bit (o el simulador), \textbf{mide}: la condición baja (tapado/frío/quieto) → anota; la alta (luz/calor/movimiento) → anota; \textbf{fija el umbral} entre las dos y actualízalo en tu bloque «si». Escribe la justificación: \emph{``baja = \_\_, alta = \_\_, umbral = \_\_''}. Ahora tu decisión se apoya en números, no en corazonadas.}
\milcpaso{3}{milcMagenta}{\textbf{Paso 3 --- Comenta tu código (5 min).} En los bloques clave, deja una \textbf{nota corta} (MakeCode permite comentarios): \emph{``aquí decido si está oscuro''}, \emph{``umbral calibrado el \_\_''}. Un código comentado es un código que otro puede seguir ---y que tú entenderás dentro de un mes.}
\milcpaso{4}{milcMagenta}{\textbf{Paso 4 --- Llévalo al río: 5 escenarios (25 min).} Saca tu tabla de 5 escenarios (la escribiste en la Actividad 2). Corre el aparato en cada uno y anota el resultado \textbf{real} junto al \textbf{esperado}. \textbf{¿Coincidieron los 5?} Si uno falla ---y busca que falle---, no lo tapes: \textbf{ajusta} (casi siempre el umbral o una regla), anota \textbf{qué cambiaste}, y \textbf{repite el escenario}. Ese ajuste documentado es la joya del módulo: prueba que tu aparato mejoró con evidencia, no con suerte.}
\milcpaso{5}{milcMagenta}{\textbf{Paso 5 --- Graba tu canoa flotando (10 min).} Con un celular, graba un \textbf{video corto} (30--60 s) mostrando tu aparato \textbf{funcionar} en al menos 2 escenarios: qué percibe, cómo reacciona. No hace falta editarlo; hace falta que se \textbf{vea funcionar}. El emberá no describe su canoa: la pone a flotar. Tu video es esa prueba.}
\milcpaso{6}{milcMagenta}{\textbf{Paso 6 --- Cierra el prototipo (10 min).} Reúne todo: el programa (comentado), la tabla de calibración, la tabla de 5 escenarios con su ajuste, y el video. \emph{Esto es un prototipo probado, no un dibujo.} En el módulo 4 vas a \textbf{evaluarlo a fondo} ---sus fallas, sus límites, su mejora--- y a decidir a quién sirve y con qué cuidado. Hoy hiciste lo que el emberá: no dijiste que tu canoa sirve; la \textbf{probaste} en el agua.}

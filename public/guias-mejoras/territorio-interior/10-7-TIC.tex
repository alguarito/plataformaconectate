...
\usepackage[hidelinks,
  pdftitle={Volver a la normalidad sin tragar entero: el rumor, la fórmula y el sentido},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Territorio interior · Educación socioemocional · Grado 10° · Momento 7 · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Grado 10° · Momento 7 · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=11.4cm,align=left] at ([xshift=1.5cm,yshift=0.5cm]gradonum.east)
    {
     ...
     {\sffamily\bfseries\fontsize{21}{25}\selectfont\setlength{\baselineskip}{27pt}Volver a la normalidad\\[4pt]sin tragar entero}\\[3.5mm]
     {\sffamily\bfseries\fontsize{15}{18}\selectfont Grado 10° · Momento 7}
    };
\end{tikzpicture}
...
El boletín verificado: tres rumores del regreso a la normalidad desmontados con las tres capas del mensaje, la cuenta que desarma el rumor químico, y la línea que separa lo que se comprueba de lo que se respeta.
\end{tcolorbox}
...
{\sffamily\fontsize{8.5}{11}\selectfont\textcolor{milcNegro!55}{Metodología MILC · Apertura ancestral · Discurso, química y ética de la información · Triángulo Dussel-Estoicismo-Floridi}}
...
\milccheckrow{Recogiste cinco mensajes reales del archivo de tu celular, ya anonimizados, y no versiones que recuerdas de memoria.}
\milccheckrow{Clasificaste cada uno en reclamo de hecho, de instrucción o de sentido, y justificaste en una línea por qué.}
\milccheckrow{Marcaste cuáles reenviaste tú en su momento, sin juzgarte por ello: es el dato más valioso de la actividad.}
...
\milcestacion{milcTurquesa}{Fase 2 · Sistematización: las capas, la cuenta, la fuente y el sentido}
...
\milcestacion{milcMagenta}{Fase 3 · Praxis: el boletín que sí sirve}
...
\rowcolor{milcGris}Verificación & \milcopcion{Separo macroestructura, microestructura y modalizadores, y distingo un reclamo de hecho de uno de sentido.} & \milcopcion{Detecto el rumor, pero aún no sé nombrar qué parte del mensaje falla.} & \milcopcion{Necesito releer la fase 2.}\\[.8mm]

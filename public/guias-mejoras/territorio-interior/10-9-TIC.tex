...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     {\sffamily\bfseries\fontsize{19}{22}\selectfont Prepararse sin\\vivir con miedo}\\[4mm]
     {\sffamily\bfseries\fontsize{23}{26}\selectfont Grado 10° · Momento 9}\\[2mm]
  ...
  \node[anchor=center,text=milcNegro,text width=17.0cm,align=center] at ([yshift=2.55cm]current page.south)
    {\sffamily\fontsize{10}{12}\selectfont Metodología MILC · Apertura ancestral · Fenómeno, probabilidad y lectura crítica · Triángulo Dussel-Estoicismo-Floridi\\
    \textcolor{milcGradeDark}{\bfseries Producto:} Tu tablero de riesgo: el histograma de las réplicas leído con datos reales, la diferencia entre probabilidad y predicción escrita con tus palabras, y el recorrido de tu casa con las tres decisiones que sí controlas.};
\end{tikzpicture}
\mbox{}
\newpage
...
\begin{checklista}
\item Listaste al menos cinco objetos que podrían caer, con el lugar exacto donde están.
\item Identificaste la ruta de salida de tu salón y contaste los pasos, señalando qué la obstruye.
\item Señalaste al menos dos lugares que sí protegen, y explicaste por qué protegen.
\end{checklista}
...
Fase 2 · Sistematización: la onda, la energía, el histograma y la probabilidad
\end{titlebox}
...
\textbf{En tu cuaderno (Actividad 2 · ANALIZA).} Título: «Actividad 2. El histograma de las réplicas». \textbf{Formato:} un histograma dibujado a mano con los datos diarios (47, 49 y unas 34) más cinco renglones de lectura. \textbf{Extensión:} el gráfico rotulado con sus dos ejes, y debajo la explicación de qué tendencia muestra y por qué el dato acumulado da otra impresión. \textbf{Sabes que terminaste cuando} tu texto usa bien las palabras frecuencia, magnitud, probabilidad y tendencia.
\end{infoband}
...
Fase 3 · Praxis: protegerse antes, durante y después
\end{titlebox}
...
Lectura de datos & Leo un histograma sin confundir frecuencia con magnitud y distingo probabilidad de predicción. & Leo el gráfico, pero aún confundo el dato acumulado con el diario. & Necesito releer la fase 2.\\

...
\usepackage[hidelinks,
  pdftitle={La ruta cuando algo pasa: qué es un tipo I, un tipo II y un tipo III},
  pdfauthor={PhD. Álvaro Cárdenas Orozco},
  pdfsubject={Territorio interior · Educación socioemocional · Grado 8° · Momento 5 · MILC v3},
  pdflang={es-CO},
...
\rhead{\small Grado 8° · Momento 5 · MILC v3\\[-1pt]{\footnotesize\strut\color{milcNegro!65}\rightmark}}
\cfoot{\small\thepage}

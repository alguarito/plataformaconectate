...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Usamos un node con fill para que el rectángulo se ajuste al texto
  % automáticamente (evita cortes cuando el contenido cambia de ancho).
  \node[fill=milcPeriodoPrimary,text=white,rounded corners=2mm,
        inner xsep=4mm,inner ysep=2mm,anchor=north east]
    at ([xshift=-2.0cm,yshift=-1.85cm]current page.north east)

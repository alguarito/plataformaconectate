...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=west,text=examenTexto,text width=17cm,align=left,
        font=\sffamily\bfseries\fontsize{26}{31}\selectfont]
    at ([xshift=2.0cm,yshift=-5.0cm]current page.north west)
    {<<<TITULO_PORTADA>>>};
\end{tikzpicture}

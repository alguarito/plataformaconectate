...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small Semillero de Investigación · <<<LINEA_NOMBRE>>>}
\rhead{\small Módulo <<<GUIA_NUMERO>>> · <<<FASE_MILC>>> · MILC v3}
\cfoot{\small\thepage}
  ...
  \node[anchor=west,text=milcGradeText,text width=8.7cm,align=left] at ([xshift=10.35cm,yshift=-11.6cm]current page.north west)
    {
     ...
     {\sffamily\bfseries\fontsize{23}{26}\selectfont <<<LINEA_NOMBRE>>>}\\[2mm]

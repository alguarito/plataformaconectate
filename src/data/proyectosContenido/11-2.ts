/**
 * Contenido web del proyecto integrador · Grado 11 · Período 2
 *
 * Auto-generado desde content/proyectos/11-2.yaml por
...
const contenido: ContenidoProyecto = {
  ...
  periodo: 2,
  clave: '11-2',
  titulo: 'Proyecto integrador · Automatización de un proceso real con IA',
  tituloPortada: 'Automatización de un proceso real',
  autor: 'Dr. Álvaro Cárdenas Orozco',
  dba: 'Mapea, diseña y automatiza un proceso digital real con criterio ético, midiendo con KPIs honestos y aplicando IA donde aporta valor sin sustituir el contacto humano que importa.',
  estrategia: 'Mapeo BPMN + Lean automation + IA como copiloto',
  duracionSemanas: 5,
  modalidad: 'equipo',
  reto: 'Identifica un proceso repetitivo y observable en tu colegio, casa o microemprendimiento familiar, mapéalo con BPMN, automatiza al menos 2 de sus pasos con Zapier/Make/n8n y conecta una IA que ayude sin reemplazar al humano que importa. Mide con 3 KPIs honestos durante 2 semanas y entrega un reporte de mejora con Kaizen.',
  insumos: [
  ...
  aprendizajes: [
    ...
    {
      sesion: 7,
      titulo: 'Chatbots sin código: flujos conversacionales'
    },
    {
      sesion: 8,
      titulo: 'KPIs: las métricas que importan'
    },
    {
      sesion: 9,
      titulo: 'Mejora continua Kaizen aplicada a procesos digitales'
    },
    {
      sesion: 10,
  ...
  entregables: [
    {
      numero: 1,
      titulo: 'Mapa BPMN del proceso elegido',
      queEntregas: 'Diagrama BPMN en draw.io o Lucidchart del proceso real elegido, exportado como PNG o PDF. Debe mostrar: actores, pasos secuenciales, decisiones (rombos), entradas/salidas y dónde se pierde tiempo. Acompañado de 1 párrafo describiendo el proceso tal como existe hoy (no como quisieras que fuera).',
      comoSeHace: [
      ...
      reflexion: {
        lente: 'dussel',
        titulo: 'A quién afecta este proceso hoy',
        consigna: 'Agrega al pie del mapa BPMN una sección titulada "A quién afecta este proceso hoy". Reconoce explícitamente qué personas viven el proceso cada día (el operario, el cliente, el supervisor, los ausentes), quién paga las consecuencias cuando falla, y a quién no estás escuchando aún en tu mapeo. Ese párrafo queda en el PDF del mapa, no como anexo escolar. Sostenerlo te impide automatizar a espaldas de quien hace el trabajo real.'
      },
      criterios: [
    ...
    },
    {
      ...
      reflexion: {
        lente: 'estoico',
        titulo: 'Lo que decidimos NO automatizar',
    ...
    {
      numero: 3,
      titulo: 'Bitácora de 3 KPIs honestos durante 2 semanas + análisis Kaizen',
      queEntregas: 'Hoja de cálculo con 3 KPIs medidos cada día durante 14 días corridos (mínimo). Al final, reporte de 1-2 páginas con: gráfico de evolución, análisis de tendencia, 1 hipótesis Kaizen sobre dónde mejorar el proceso para el siguiente ciclo, y propuesta de cambio concreto.',
      comoSeHace: [
    ...
    {
      numero: 4,
      titulo: 'Sustentación pública + declaración honesta de IA y de límites del workflow',
  ...
  rubrica: [
    {
      entregable: 1,
      nivel5: 'Proceso real bien observado, BPMN correcto, fricción identificada, Dussel visible',
      nivel3: 'BPMN aceptable pero observación superficial o fricción mal identificada',
      nivel1: 'Proceso hipotético, BPMN con errores o sin entrevista'
    },
    {
      entregable: 2,
      nivel5: 'Workflow funcional con IA con propósito, 5+ ejecuciones, estoico visible',
      nivel3: 'Workflow maquetado o IA de adorno, pocas ejecuciones reales',
      nivel1: 'Workflow no funciona o sin nodo de IA'
    },
    {
      entregable: 3,
      nivel5: '14 días sin huecos, gráfico honesto, hipótesis Kaizen accionable, Floridi visible',
      nivel3: 'Datos con huecos o KPIs vanity, propuesta Kaizen genérica',
      nivel1: 'Datos insuficientes o gráfico engañoso (eje truncado)'
    },
    {
      entregable: 4,
      nivel5: '5 min exactos, demo en vivo, 3 lentes con decisión concreta, límites honestos',
      nivel3: 'Sustentación con tiempo descontrolado o triángulo retórico',
      nivel1: 'No sustentó, demo falló sin reconocer o triángulo ausente'
    },
    {
      entregable: 'global',
      nivel5: 'El proceso real, el workflow, los KPIs y las decisiones del triángulo dialogan',
      nivel3: 'Coherencia parcial entre las partes',
      nivel1: 'Las partes no se conectan; parecen ejercicios separados',
      titulo: 'Coherencia entre mapeo, automatización, métricas y triángulo'
    }
  ],
  sustentacion: {
    duracionMin: 5,

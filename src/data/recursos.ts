// Auto-generado desde Drive + manifests CSV
// Total: 180 guías (30 × 6 grados, agrupadas en 3 períodos × 10 sesiones)
...
export function getRecurso(grado: number, periodo: number, sesion: number): RecursoGuia | undefined {
  return recursos.find(r => r.grado === grado && r.periodo === periodo && r.sesion === sesion);
}

export function pdfPreviewUrl(id: string): string {

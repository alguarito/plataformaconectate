...
const grado10: Nivel = {
  ...
  momentos: [
    ...
    // se diluye en «así le dicen aquí a la ansiedad».
    {
      numero: 1,
      slug: 'momento-1',
      nombre: 'Ansiedad: qué es y qué no',
      foco: 'La ansiedad que avisa y la que incapacita, separadas por cuatro criterios ---interferencia, persistencia, intensidad, malestar---. Evitar alivia hoy y la agrava mañana.',
      ancla:a('La «enfermedad de los nervios»: nombre popular del sufrimiento que se siente en el cuerpo, documentado en Sevilla y Barragán, Valle del Cauca, y registrado como consecuencia de las violencias del conflicto armado (Piedrahita Forero y Tabares, 2021)', 'verificada'),
      estado: 'activo',
      claveGuia: '10-1',
    },
    {
      numero: 2,
      slug: 'momento-2',
      nombre: 'Lo que controlo y lo que no',
      foco: 'Dos estrategias de afrontamiento y la regla que decide cuál sirve: la centrada en el problema para lo modificable, la centrada en la emoción para lo que no lo es.',
      ancla:a('La roya del cafeto, detectada en Chinchiná (Caldas) en 1983, y la Variedad Colombia que Cenicafé entregó en 1984 ---fruto de veinte años de mejoramiento iniciados antes de que la roya llegara al país---', 'verificada'),
      estado: 'activo',
      claveGuia: '10-2',
    },
    {
      numero: 3,
      slug: 'momento-3',
      nombre: 'Tristeza, depresión y ayuda',
      foco: 'Se mira lo que cambió, no la intensidad. Y la atención en salud mental es un derecho con prioridad para adolescentes, no un favor.',
      ancla:a('Los médicos tradicionales nasa y el «refrescar»: rituales con que se limpia, se refresca y se cura a la persona y al territorio ---hay a quién acudir, el malestar no avergüenza y nadie va solo--- (Drexler, 2004)', 'verificada'),
      estado: 'activo',
      claveGuia: '10-3',
    },
    {
      numero: 4,
      slug: 'momento-4',
      nombre: 'Si alguien me lo dice',
      foco: 'Protocolo de tres pasos ---preguntar, quedarse, avisar---, nunca diagnóstico. Preguntar directamente por la ideación suicida no la induce: trece estudios, ninguno halló aumento (Dazzi y otros, 2014).',
      ancla:a('La Guardia Indígena del Cauca: no porta armas, su función es alertar y acompañar más que resolver, y nunca actúa sola', 'verificada'),
      estado: 'activo',
      claveGuia: '10-4',
    },
    {
      ...
      slug: 'momento-5',
      nombre: 'Duelo',
      foco: 'No hay etapas que cumplir ---el modelo secuencial ajusta mal a los datos---. Lo que un duelo necesita no es apuro sino compañía organizada.',
      ancla:a('El novenario ---nueve días en que la comunidad se reúne a rezar al caer la tarde--- y el levantamiento de tumba del noveno día. Gualíes, alabaos y levantamientos son Patrimonio Inmaterial de la Nación desde 2014', 'verificada'),
      estado: 'activo',
      claveGuia: '10-5',
    },
    {
      ...
      slug: 'momento-6',
      nombre: 'Anestesias',
      foco: 'Sustancias, apuestas y pantallas son la misma maniobra con herramientas distintas: evitar una emoción. El costo no se mide en cantidad sino en lo que se dejó de hacer.',
      ancla:a('La amapola en Tierradentro: en los años noventa alteró las dinámicas comunitarias y las prácticas culturales nasa ---lo primero que cambió fue la forma de vestir y de comer--- hasta amenazar su continuidad cultural; la comunidad dejó de sembrarla tras leer la avalancha de 1994 como un reclamo de la madre tierra', 'verificada'),
      estado: 'activo',
      claveGuia: '10-6',
    },
    {
    ...
    },
    {
      numero: 10,
      slug: 'momento-10',
      nombre: 'Cuidar al que cuida',
      foco: 'Acompañar no es cargar. Cuidar con sobrecarga tiene un costo medido: 63 % más riesgo de mortalidad (Schulz y Beach, 1999). El problema es la sobrecarga, no el cuidado.',
      ancla:a('Quién sostiene a las cantadoras de alabao ---que cantan un velorio tras otro durante años---. Dos cosas sí resueltas: no cantan solas, y el oficio tiene un final marcado al noveno día', 'verificada'),
      estado: 'activo',
      claveGuia: '10-10',
    },
  ],
  ...
  momentos: [
    {
      numero: 1,
      slug: 'momento-1',
      nombre: 'Quién soy cuando nadie mira',
      foco: 'El carácter no se delega en un truco: el margen que todos nos damos, y por qué lo que sostiene una vida se decide donde no hay testigos.',
      ancla:a('El oficio del calado heredado en Cartago de abuela a nieta: la calidad se decide en el revés ---los nudos, los remates--- y el revés lo mira solo quien hizo la pieza', 'verificada'),
      estado: 'activo',
      claveGuia: '11-1',
    },
    {
      numero: 2,
      slug: 'momento-2',
      nombre: 'La trampa de compararse',
      foco: 'Lo decisivo no es cuánta autoestima se tiene sino de qué dominios se hizo depender el valor propio, y quién puso esa vara.',
      ancla:a('Fals Borda en Saucío (1949-1953): llegó a medir una vereda con las escalas de la universidad y terminó inventando la investigación acción participativa, una relación horizontal entre saber académico y saber popular', 'verificada'),
      estado: 'activo',
      claveGuia: '11-2',
    },
    {
      numero: 3,
      slug: 'momento-3',
      nombre: 'Decidir con miedo',
      foco: 'La certeza no llega y esperarla ya es decidir; el miedo exagera de forma medida, y lo que cambia la estrategia es si la decisión se puede deshacer.',
      ancla:a('La Sociedad Anónima Burila, constituida por escritura pública n.º 693 del 25 de noviembre de 1884 en Manizales con cien accionistas, que disputó a los colonos de Salento y Calarcá las tierras que ellos estaban abriendo: abrir trocha no daba la tierra', 'verificada'),
      estado: 'activo',
      claveGuia: '11-3',
    },
    {
      numero: 4,
      slug: 'momento-4',
      nombre: 'El trabajo y la dignidad',
      foco: 'Empleo, carrera y vocación son relaciones con el trabajo, no tipos de oficio: el mismo cargo admite las tres. Y dignidad y salario son cosas distintas que se reclaman las dos.',
      ancla:a('El calado del Norte del Valle como oficio con nombre propio: la pieza se reconoce y se sabe de qué mano salió ---y es un trabajo mal pagado, lo que muestra que la dignidad de un oficio y lo que paga no son lo mismo---', 'verificada'),
      estado: 'activo',
      claveGuia: '11-4',
    },
    {
      numero: 5,
      slug: 'momento-5',
      nombre: 'Irse o quedarse',
      foco: 'Lo que decide una migración no es la distancia ni el mérito sino la red que se encuentra al llegar; y a largo plazo pesa más lo que no se hizo.',
      ancla:a('Las redes de paisanos documentadas en la migración interna colombiana: se configuraban para estimular, facilitar y apoyar la llegada, y quienes llegaban después de los pioneros se adaptaban mejor porque encontraban paisanos ya establecidos', 'verificada'),
      estado: 'activo',
      claveGuia: '11-5',
    },
    {
      numero: 6,
      slug: 'momento-6',
      nombre: 'Sostenerse afuera',
      foco: 'El colegio venía haciendo gratis el trabajo de poner a la gente junta todos los días. La red no aparece: se arma con horarios, no con intenciones.',
      ancla:a('La regionalización de la Universidad del Valle, nacida en 1986 bajo el rector Harold Rizo Otero, con Cartago entre las primeras sedes y programas presenciales desde el 20 de octubre de 1986: no se pidió más valentía, se cambió la estructura', 'verificada'),
      estado: 'activo',
      claveGuia: '11-6',
    },
    {
      numero: 7,
      slug: 'momento-7',
      nombre: 'Ciudadanía emocional',
      foco: 'Deliberar no es convencer, y el contacto sostenido con quien piensa distinto reduce el prejuicio. Lo que obliga a decidir juntos es una tarea común.',
      ancla:a('La Junta de Acción Comunal: según la Ley 743 de 2002 la constituyen personas naturales mayores de catorce años que residan en el territorio, y el acto de afiliación es la inscripción directa en el libro de afiliados', 'verificada'),
      estado: 'activo',
      claveGuia: '11-7',
    },
    {
      numero: 8,
      slug: 'momento-8',
      nombre: 'Lo que le debo al lugar',
      foco: 'Casi nada de lo que se usa lo hizo uno, y lo que dura solo dura porque alguien en cada generación hace el trabajo de sostenerlo.',
      ancla:a('Kiwe entre los nasa ---«mai kiwe», «kwe\'sx kiwe», «nasa kiwe»---: una relación de hermandad con la tierra y no de propiedad, orientada por los «kiwe thë», los sabios de la tierra', 'verificada'),
      estado: 'activo',
      claveGuia: '11-8',
    },
    {
      ...
      slug: 'momento-9',
      nombre: 'Mentoría',
      foco: 'Acompañar durante un periodo a un estudiante de 6.º: lo que produce el efecto es el vínculo y la constancia, no la cantidad de encuentros, y el cierre explícito es obligatorio.',
      ancla:a('La minga intergeneracional: a cada quien se le da tarea a su medida, el que empieza tiene una tarea real y aprende al lado de alguien que sabe', 'verificada'),
      estado: 'activo',
      claveGuia: '11-9',
    },
    {
      ...
      slug: 'momento-10',
      nombre: 'Devolver',
      foco: 'Proyecto de vida entendido como cuidado, con acto público de cierre. La devolución es la quinta fase del MILC y no la última: después viene una pregunta nueva.',
      ancla:a('La devolución, quinta fase del MILC ---Escucha, Sistematización, Praxis, Evaluación liberadora, Devolución--- tras la cual el ciclo no cierra sino que abre otra pregunta', 'verificada'),
      estado: 'activo',
      claveGuia: '11-10',
    },
  ],
